...
public class MiddleManager : MonoBehaviour
{
    ...
    public AiDeck loadedDeck;
    public List<AiCard> deckCards;
    public List<TextMeshProUGUI> deckInfo;
    public List<AiDeck> myDecks = new List<AiDeck>();
    ...
    IEnumerator Start()
    {
        ...
        //AiDeck first_timer = deckController.first_timer;
        //Debug.Log("AiDeck to select: " + first_timer.Name);
    ...
    public void LoadDecks()
    {
        ...
        {
            AiDeck auxdeck = deckController.LoadDeckFromPath(path);
    ...
    {
        AiCard leader_card = deckController.GetCardStats(loadedDeck.Leader);
