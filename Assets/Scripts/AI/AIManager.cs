...
public class AIManager : MonoBehaviour
{
    ...
    public void AIExchangeCards()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            // Exchange Impenetrable Fog AiCard
    ...
    public void AIStartTurn()
    {
        ...
        List<AiCard> hand_cards = controller.GetCardsList(controller.EnemyInfo.HandList); // List of all cards in hand
        List<AiCard> hand_units = controller.GetCardsList(GetHandUnits());                // List of all unit cards in hand (except dandelion)
        List<AiCard> hand_specials = controller.GetCardsList(GetHandSpecials());          // List of special cards in hand
